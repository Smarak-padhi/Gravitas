...
// Canonical Personal OS Background Job & Notification Kernel (Wave 12I)
export {
  ...
  type CronTrigger,
  type UnsupportedTrigger,
  type JobTrigger,
  type EmitNotificationAction,
  type RepositoryCheckAction,
  ...
  type AutonomyLevel,
  type JobExecutionBudget,
  type RetryPolicy,
  type QuietHoursWindow,
  type JobNotificationPolicy,
  type BackgroundJob,
  type JobRunAttempt,
  type JobRun,
